...
namespace Qandil.Service.IServices
{
    ...
    {
        public  Task<Result<PagedResult<Answer>>> GetAnswersByDiagnosisId(Guid id);
        ...
        public  Task<Result<EvaluationCard>> CalculateEvaluationForCard(List<Answer> answers, string cardName);
